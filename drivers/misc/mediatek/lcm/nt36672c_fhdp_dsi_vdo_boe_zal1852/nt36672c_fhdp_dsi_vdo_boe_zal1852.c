...
#define LOG_TAG "LCM_NT36672C_BOE_HC_SALA"
...
#define NT36672C_LCM_ID_SALA (0x11)
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	register_device_proc("lcd", "nt36672c_boe_hlt", "boe");
/* Longyajun@ODM.HQ.Multimedia.LCM 2019/12/02 modified for corner */
#ifdef CONFIG_MTK_ROUND_CORNER_SUPPORT
...
{
    	LCM_LOGD("%s,nt36672c boe backlight: level = %d\n", __func__, level);
		if (level == 0){
...
LCM_DRIVER nt36672c_fhdp_dsi_vdo_boe_zal1852_lcm_drv = {
    .name = "nt36672c_boe_sala",
