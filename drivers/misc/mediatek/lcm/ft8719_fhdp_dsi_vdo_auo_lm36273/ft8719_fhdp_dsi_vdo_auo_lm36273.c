...
static void lcm_init(void)
{
	...
	LCM_LOGD("ft8719----tps6132----lcm mode = vdo mode :%d----\n",
			 lcm_dsi_mode);
}
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	LCM_LOGD("%s, ft8719 backlight: level = %d\n", __func__, level);
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGD("%s,ft8719_id=0x%08x,version_id=0x%x\n",
...
struct LCM_DRIVER ft8719_fhdp_dsi_vdo_auo_lm36273_lcm_drv = {
	.name = "ft8719_fhdp_dsi_vdo_auo_lm36273_lcm_drv",
