...
* LOGDC_RESET[1] - (RW) Resets PLE logic circuit
* INIT_DONE[2] - (RO) PLE control SRAM initialization
indicator
* UMAC_CFG_LOGDC_RESET[3] - (RW) Resets PF/MDP/SEC/UWTBL logic circuit
...
#define WF_PLE_TOP_GC_UMAC_CFG_LOGDC_RESET_ADDR WF_PLE_TOP_GC_ADDR
#define WF_PLE_TOP_GC_UMAC_CFG_LOGDC_RESET_MASK \
	0x00000008 /* UMAC_CFG_LOGDC_RESET[3] */
#define WF_PLE_TOP_GC_UMAC_CFG_LOGDC_RESET_SHFT 3
...
#define WF_PLE_TOP_GC_LOGDC_RESET_ADDR WF_PLE_TOP_GC_ADDR
#define WF_PLE_TOP_GC_LOGDC_RESET_MASK 0x00000002 /* LOGDC_RESET[1] */
#define WF_PLE_TOP_GC_LOGDC_RESET_SHFT 1
...
* DRR_LOGDC_RESET[26] - (RW) DRR logic reset control
...
#define WF_PLE_TOP_VOW_CONTROL_DRR_LOGDC_RESET_ADDR WF_PLE_TOP_VOW_CONTROL_ADDR
#define WF_PLE_TOP_VOW_CONTROL_DRR_LOGDC_RESET_MASK  \
	0x04000000 /* DRR_LOGDC_RESET[26] */
#define WF_PLE_TOP_VOW_CONTROL_DRR_LOGDC_RESET_SHFT 26
