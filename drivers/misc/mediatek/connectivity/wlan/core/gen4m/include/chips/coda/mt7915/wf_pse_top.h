...
* LOGDC_RESET[1] - (RW) Resets PSE logic circuit
...
#define WF_PSE_TOP_GC_LOGDC_RESET_ADDR WF_PSE_TOP_GC_ADDR
#define WF_PSE_TOP_GC_LOGDC_RESET_MASK 0x00000002 /* LOGDC_RESET[1] */
#define WF_PSE_TOP_GC_LOGDC_RESET_SHFT 1
