...
#define F_MMU_PT_BASE_ADDR_31_07             F_MSK(31, 7)
#define F_MMU_PT_BASE_ADDR_33_32             F_MSK(1,  0)
#define F_MMU_PT_BASE_ADDR_32                F_BIT_SET(0)
#define F_MMU_PT_BASE_ADDR_33                F_BIT_SET(1)

#define REG_MMU_STA                          (0x08)
#define F_MMU_STA_MASK                       F_MSK(18, 0)
...
#define F_MMU_MTLB_LOGDC_STALL_DCM    F_BIT_SET(14)
...
#define F_MMU_L2_LOGDC_STALL_DCM    F_BIT_SET(17)
#define F_MMU_TOP_STALL_DCM     F_BIT_SET(16)
#define F_MMU_APB_DCM	   F_BIT_SET(9)
#define F_MMU_MTLB_LOGDC_DCM    F_BIT_SET(6)
...
#define F_MMU_L2_LOGDC_DCM    F_BIT_SET(1)
...
#define F_MMU_MMU1_AXI_INTF                  F_MSK(25, 13)
#define F_MMU_MMU0_AXI_INTF                  F_MSK(12, 0)

#define REG_MMU_DBG4                         (0x70)
#define F_MMU_MMU1_GLB_DATA_CNT              F_MSK(23, 12)
#define F_MMU_MMU0_GLB_DATA_CNT              F_MSK(11, 0)

#define REG_MMU_DBG5                         (0x74)
#define F_MMU_L2_TLB_DBG                     F_MSK(30, 16)
#define F_MMU_MISC_DBG_STA                   F_MSK(15, 0)

#define DEBUG_REG_NR         (6)

#define REG_MMU_COH_THROT_CTRL               (0x90)
#define F_MMU_COH_THROT_WLMT_1               F_MSK(15, 14)
#define F_MMU_COH_THROT_WEN_1                F_BIT_SET(12)
#define F_MMU_COH_THROT_RLMT_1               F_MSK(11, 10)
#define F_MMU_COH_THROT_REN_1                F_BIT_SET(8)
#define F_MMU_COH_THROT_WLMT_0               F_MSK(7, 6)
#define F_MMU_COH_THROT_WEN_0                F_BIT_SET(4)
#define F_MMU_COH_THROT_RLMT_0               F_MSK(3, 2)
#define F_MMU_COH_THROT_REN_0                F_BIT_SET(0)

#define REG_MMU_TBW_ID                       (0xA0)
#define F_MMU_PFTH_TBW_ID                    F_MSK(31, 16)
#define F_MMU_MISS_TBW_ID                    F_MSK(15, 0)
...
#define REG_MMU_RSx_ST(mmu, rs_id) \
	(0x38c + (mmu) * MMU01_SQ_OFFSET + (rs_id) * 16)
...
#define F_MMU_RSx_ID                         F_MSK(31, 16)
#define F_MMU_RSx_TO                         F_BIT_SET(8)
#define F_MMU_RSx_VLD                        F_BIT_SET(7)
#define F_MMU_RSx_WRT_CMD                    F_BIT_SET(6)
#define F_MMU_RSx_RDY2REQ                    F_BIT_SET(5)
#define F_MMU_RSx_PA_RDY                     F_BIT_SET(4)
#define F_MMU_RSx_IS_PHEAD                   F_BIT_SET(3)
#define F_MMU_RSx_IS_PTAIL                   F_BIT_SET(2)
#define F_MMU_RSx_IS_LHEAD                   F_BIT_SET(1)
#define F_MMU_RSx_IS_LTAIL                   F_BIT_SET(0)
